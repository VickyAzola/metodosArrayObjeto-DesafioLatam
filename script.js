...
//1. Agregar elementos al arreglo de Traumatología
...
let listaDental = document.getElementById("listaDental")

for (consulta of dental) {
  listaDental.innerHTML += `
    <li>${consulta.hora} - ${consulta.especialista} - ${consulta.paciente} - ${consulta.rut} - ${consulta.prevision}</li>
  `
}
//------------------------------
...
let listaPacientes = radiologia.concat(traumatologia, dental)

for (nombre of listaPacientes) {
...
//5. Filtrar pacientes que son de ISAPRE en la lista Dental 

let listaIsapreDental = dental.filter((paciente) => {
  return paciente.prevision == "ISAPRE"
})

console.log(listaIsapreDental)
//----------------------------------

//6. Filtrar pacientes que son de FONASA en la lista Traumatología
let listaFonasaTrauma = traumatologia.filter((paciente) => {
  return paciente.prevision == "FONASA"
})

console.log(listaFonasaTrauma)
//----------------------------------
